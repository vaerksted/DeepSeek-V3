...
<div align=right>
<a href="https://github.com/deepseek-ai/DeepSeek-V3/blob/main/INTRO.pod#1-簡介">中文</a>
/ <a href="https://github.com/deepseek-ai/DeepSeek-V3/blob/main/INTRO.pod#1-giriş">Türkçe</a>
</div>
...
B<Architecture: Innovative Load Balancing Strategy and Training Objective>
...
B<Pre-Training: Towards Ultimate Training Efficiency>
...
B<Post-Training: Knowledge Distillation from DeepSeek-R1>
...
B<Summary of Core Evaluation Results>

=over 4

=item *

B<Knowledge:> (1) On educational benchmarks such as MMLU, MMLU-Pro, and GPQA,
...
B<Code, Math, and Reasoning:> (1) DeepSeek-V3 achieves state-of-the-art performance on
